<template>
    <div class="d-flex align-items-center">
        ...
        <form class="w-100 text-center ml-4" @submit.prevent="sendComment">
            <label for="text_post" class="font-weight-bold m-0 mb-2">
                <span v-if="type === 'answer'">Répondre au commentaire</span>
            ...
            <div class="container_comment d-flex align-items-center">                  
                ...
                <div>
                    <button type="submit" class="bg-dark text-white rounded-pill ml-3 px-2 py-2">
                        <span v-if="type === 'answer'">Répondre</span>
